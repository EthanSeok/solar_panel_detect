...
def process_image(image_path, api_key, model, result_dir, conf_threshold=0.6):
...
def main(directory, api_key, output_dir, conf_threshold=0.6):
...
if __name__ == '__main__':
    ...
    api_key = ""
    conf_threshold = 0.6  # 설정하려는 confidence threshold 값
    main(directory, api_key, output_dir, conf_threshold)
